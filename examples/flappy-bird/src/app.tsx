        ...
        <div className="min-h-screen bg-gray-900 flex items-center justify-center">
            ...
            >
                ...
                <If
                    ...
                    then={
                        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black/70 text-white text-xl font-bold text-center py-3 px-8 rounded">
                            Press SPACE to jump
                        </div>
                    }
                />
