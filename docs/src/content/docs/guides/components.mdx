...
import MyButtonComponentImage from '../../../assets/MyButtonComponent_480.gif';

<Image
    style={{ margin: 'auto', display: 'block', padding: '1rem' }}
    src={MyButtonComponentImage} alt="MyButtonComponent" />
...
import MouseMovementPadImage from '../../../assets/MouseMovementPad_480.gif';

<Image
    style={{ margin: 'auto', display: 'block', padding: '1rem' }}
    src={MouseMovementPadImage} alt="MouseMovementPad" />
