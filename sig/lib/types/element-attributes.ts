...
export type AreaElementAttributes = HTMLElementAttributes<HTMLAreaElement> & Signalize<{
    alt: string;
    coords: string;
    download: string;
    href: string;
...
export type ImgElementAttributes = HTMLElementAttributes<HTMLImageElement> & Signalize<{
    alt: string;
    crossorigin?: "anonymous" | "use-credentials";
...
export type OptionElementAttributes = HTMLElementAttributes<HTMLOptionElement> & Signalize<{
    disabled?: boolean;
    label?: string;
    selected?: boolean;
    value?: string;
...
export type SelectElementAttributes = HTMLElementAttributes<HTMLSelectElement> & Signalize<{
    autocomplete?: "on" | "off";
    disabled?: boolean;
    form?: string;
    multiple?: boolean;
