import type { VirtualElementChild, VirtualElement, ComponentFunction, Props } from "@/types";
...
export function createElement<T = Record<string, unknown>>(type: string | ComponentFunction<T> | HTMLElement | Element | Text, props: Props<T>, ...children: VirtualElementChild[]): VirtualElement
